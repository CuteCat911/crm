...
// import {getObjectLength} from "../modules/get-associative-array-length";

// export let Mask = class {

//   constructor(params) {

//     if (params.elements && typeof params.elements === "string") {
...
//           elements: findElemsClass(params.elements, document),
//           info: {}
//         },
//         options: {
...
//       if ($info.masks.elements) {

//         this.__setElemsInfo("all");

//         for (let elem of $info.masks.elements) {
...
//       for (let i in $masks.elements) {

//         $setElemInfo($masks.elements[i], i);

//       }

//     } else if (mode == "single" && (elem && typeof elem === "object")) {

//       let infoLength = getObjectLength($masks.info);
