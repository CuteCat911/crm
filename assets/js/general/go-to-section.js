...
//           elements: (findElemsClass(params.pointers, document)) ? findElemsClass(params.pointers, document) : null
//         },
//         section: {
//           class: params.sections,
//           elements: (findElemsClass(params.sections, document)) ? findElemsClass(params.sections, document) : null
//         },
//         header: {
...
//       if ($pointer.elements && $section.elements && !$options.dynamic) {

//         for (let $pointerElem of $pointer.elements) {
...
//     $pointer.elements = findElemsClass($pointer.class, document);
//     $section.elements = findElemsClass($section.class, document);
...
//         for (let $sectionElem of $section.elements) {
